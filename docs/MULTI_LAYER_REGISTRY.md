...
**Invariants** (checked by `test:cross-cutting-allowlists`):
...
**Canonical post-mortem**: session 2026-05-21, commits `51feecf` → `f097b42` → `2fc26c8` → `be1eca2` (4 commits for 1 bug). Forbidden #17 codifies the rule.
