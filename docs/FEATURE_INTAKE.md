...
User prompt
    |
    v
Create GitHub issue (skeleton)        ← gh issue create --repo hoainho/ohmyperf
...
Touches auth, authorization, data-model, audit-security, external-providers, public-api, or multi-domain scope (4+ risk flags, or any hard gate).
...
Hard gates: auth, authorization, data-model, audit-security, external-providers, public-api.
